...
namespace InnometricsVSTracker
{
    ...
    internal sealed class LoginCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("e96b9a6d-8fbf-4156-bab5-d0a4906bebe9");
        ...
        private LoginCommand(Package package)
        {
            if (package == null)
            {
            ...
            if (commandService != null)
            {
                ...
                var menuItem = new MenuCommand(this.ShowLoginForm, menuCommandID);
        ...
        /// </summary>
        public static LoginCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new LoginCommand(package);
        }
